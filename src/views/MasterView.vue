<template>
    ...
    <header id="home">
        ...
        <!-- Start Navigation -->
        <nav class="navbar navbar-default navbar-fixed navbar-transparent dark bootsnav shadow-less">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav navbar-right" data-in="#" data-out="#">
                        ...
                        <li class="dropdown">
                            <a href="menu-1.html" class="dropdown-toggle active" data-toggle="dropdown" >Menu</a>
                        </li>  
                        <li>
                ...
                <div class="offer-items offer-carousel owl-carousel owl-theme">
                    ...
                    <div class="item">
                        ...
                        <div class="col-md-6 info">
                            ...
                            <a class="btn btn-dark border btn-md" href="#">Book a table</a>
                        </div>
                    </div>
                    <!-- End Single Item -->
                    <!-- Single Item -->
